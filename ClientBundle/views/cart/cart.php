...
?>
                <tr>
                    <td><img src="<?= (file_exists('uploads/thumbnails/files/'.$_SESSION['id_organization'].'/contents/thumbnail_content_'.$content['id'].'.png') ? 'uploads/thumbnails/files/'.$_SESSION['id_organization'].'/contents/thumbnail_content_'.$content['id'].'.png' : 'ClientBundle/ressources/content/img/default_content.png') ?>" height="100" width="100"></td>
