...
<div id="container">
	...
	<form id="form" class="design-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . '?' . $_SERVER['QUERY_STRING']); ?>" method="POST">
		...
		<input type="color" name="design_mediastorage[body][background-color][value]" id="design_mediastorage[body][background-color][value]" value="<?= (isset($designs['body']['background-color']['value'])) ? $designs['body']['background-color']['value'] : '#a6a6a6' ?>" /><br />
		...
		<input type="color" name="design_mediastorage[body][color][value]" id="design_mediastorage[body][color][value]" value="<?= (isset($designs['body']['color']['value'])) ? $designs['body']['color']['value'] : '#000000' ?>" /><br />
		...
		<input type="color" name="design_mediastorage[.form][background-color][value]" id="design_mediastorage[.form][background-color][value]" value="<?= (isset($designs['.form']['background-color']['value'])) ? $designs['.form']['background-color']['value'] : '#f2f2f2' ?>" /><br />
		...
		<input type="color" name="design_mediastorage[.form][color][value]" id="design_mediastorage[.form][color][value]" value="<?= (isset($designs['.form']['color']['value'])) ? $designs['.form']['color']['value'] : '#000000' ?>" /><br />
		...
		<input type="color" name="design_mediastorage[.form button][background-color][value]" id="design_mediastorage[.form button][background-color][value]" value="<?= (isset($designs['.form button']['background-color']['value'])) ? $designs['.form button']['background-color']['value'] : '#404040' ?>" /><br />
		...
		<input type="color" name="design_mediastorage[.form button][color][value]" id="design_mediastorage[.form button][color][value]" value="<?= (isset($designs['.form button']['color']['value'])) ? $designs['.form button']['color']['value'] : '#d9d9d9' ?>" /><br />
