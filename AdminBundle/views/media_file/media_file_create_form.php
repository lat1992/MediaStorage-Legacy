<div style="width: 100%; text-align: center;">
	<form action="<?php echo htmlspecialchars('?page=create_content_by_multiple_files_admin'); ?>" method="POST" style="margin: 0 auto">
...
*/ ?>
		<input type="submit" value="<?= MULTIPLE_QUALIFICATION ?>" />
