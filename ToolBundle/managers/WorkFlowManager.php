...
class WorkFlowManager {
	...
	public function transcoding($id_file, $file_path) {
		...
		else if (strpos($wf_type, 'image') !== false || strpos($wf_type, 'application/x-photoshop') !== false || strpos($wf_type, 'application/photoshop') !== false || strpos($wf_type, 'application/psd') !== false || (strpos($wf_type, 'application/pdf') !== false && strpos(pathinfo($file_path, PATHINFO_EXTENSION), 'ai') !== false))
