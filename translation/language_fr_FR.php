...
define('FOLDER_TITLE_BLOCK', 'Block titre');
define('FOLDER_DESCRIPTION_BLOCK', 'Block description');
define('PROGRAM_SECTION_LINE', 'Separation ligne programme');
define('PROGRAM_TITLE_BLOCK', 'Block titre');
define('PROGRAM_DESCRIPTION_BLOCK', 'Block description');
define('CONTENT_SECTION_LINE', 'Separation ligne contenu');
define('CONTENT_TITLE_BLOCK', 'Block titre');
define('CONTENT_DESCRIPTION_BLOCK', 'Block description');